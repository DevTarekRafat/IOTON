      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <ol>
            ...
            <ul>
              <li>
                <span className="fw-bold">Account</span> means a unique account
                created for You to access our Service or parts of our Service.
              </li>
              <li>
                <span className="fw-bold">Affiliate</span> means an entity that
              ...
              <li>
                <span className="fw-bold">Application</span> means the software
                program provided by the Company downloaded by You on any
                electronic device, named Ioton
              </li>
              <span className="fw-bold">Company</span> (referred to as either
              "the Company", "We", "Us" or "Our" in this Agreement) refers to
              IOTON LIMITED, Kemp House, 160 City Road, London, United Kingdom,
              EC1V 2NX.
              <li>
                <span className="fw-bold">Cookies</span> are small files that
              ...
              <li>
                <span className="fw-bold">Country</span> refers to: United
                Kingdom
              </li>
              <li>
                <span className="fw-bold">Device</span> means any device that
                can access the Service such as a computer, a cellphone or a
                digital tablet.
              </li>
              <li>
                <span className="fw-bold">Personal</span> Data is any
              ...
              <li>
                <span className="fw-bold">Service</span> Provider means any
              ...
              <li>
                <span className="fw-bold">Usage</span> Data refers to data
              ...
              <li>
                <span className="fw-bold">Website</span> refers to Ioton,
                accessible from https://ioton.io/
              </li>
              <li>
            ...
            <br />
            <h4>Information regarding your location</h4>
            <br />
            <p>
            ...
            <p>
              ...
              https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main-Where-can-I-change-the-settings-for-disabling-or-deleting-local-shared-objects-
            </p>
            <p>
            ...
            <p>
              ...
              Your web browser. Learn more about cookies: Use of Cookies by Free
              Privacy Policy.
            </p>
            <br />
            <p>
