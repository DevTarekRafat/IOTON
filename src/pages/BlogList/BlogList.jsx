...
const BlogList = () => {
  ...
  return (
    ...
    <div>
      ...
      {/*<Card date={"March 15, 2022"}  title={"The Importace of IOT in industry"} owner={"Amaia"} src={Blog3Image} params={"The Internet of Things is already present and growing in popularity. IoT’s refer to Internet-connected devices such as smartwatches, Fitbit, or refrigerator..."} linkto={"electric"}/> */}
      </div>
      <br/>
  </div>
  );
